...
const HrCompliancePage = () => {
  ...
  const quickNavSections = [
    ...
    { id: 'compliance-suite', label: 'Compliance Suite', icon: FaShieldHalved },
    { id: 'guides', label: 'Compliance Guides', icon: FaBookOpen },
    { id: 'documentation', label: 'Documentation', icon: FaFileArchive },
  ...
  return (
    <>
    <div className="min-h-screen bg-gradient-to-br from-emerald-50/20 via-white to-teal-50/20 relative">
      ...
      {/* Hero Section */}
      <section id="hero" className="scroll-mt-24 relative overflow-hidden bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 animate-gradient">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-6 mb-8">
              {quickNavSections.slice(1).map((section) => (
                <button
                  key={section.id}
                  onClick={() => scrollToSection(section.id)}
                  className="px-3 py-1.5 bg-emerald-500/10 backdrop-blur-sm text-white text-sm rounded-full hover:bg-emerald-500/20 transition-all flex items-center gap-2 border border-emerald-200"
                >
        ...
        <div className="mb-12">
          <div className="flex flex-wrap justify-center gap-4 mb-8 animate-buttons-stagger">
            {[
              ...
              >
                <tab.icon className={activeTab === tab.id ? 'animate-spin-slow' : ''} />
                {tab.label}
              </button>
            ))}
          </div>
          ...
          <section id="compliance-suite" className="scroll-mt-24">
            {activeTab === 'suite' && (
